## depthai (lyrical) - 3.10.0-1

The packages in the `depthai` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release --rosdistro lyrical depthai` on `Mon, 07 Sep 2026 10:58:55 -0000`
...
## depthai (kilted) - 3.10.0-1

The packages in the `depthai` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted depthai` on `Mon, 07 Sep 2026 10:56:26 -0000`
...
## depthai (lyrical) - 3.9.0-2

The packages in the `depthai` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release --rosdistro lyrical --track lyrical depthai` on `Mon, 24 Aug 2026 13:25:30 -0000`
...
## depthai (lyrical) - 3.9.0-1

The packages in the `depthai` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release --new-track --rosdistro lyrical --track lyrical depthai` on `Mon, 24 Aug 2026 13:15:41 -0000`
...
## depthai (kilted) - 3.9.0-1

The packages in the `depthai` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted depthai` on `Mon, 17 Aug 2026 12:01:39 -0000`
...
## depthai (kilted) - 3.7.1-3

The packages in the `depthai` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted depthai` on `Wed, 10 Jun 2026 11:51:28 -0000`
...
## depthai (kilted) - 3.7.1-2

The packages in the `depthai` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted depthai` on `Wed, 10 Jun 2026 11:39:15 -0000`
...
## depthai (humble) - 2.31.1-1

The packages in the `depthai` repository were released into the `humble` distro by running `/usr/bin/bloom-release depthai --rosdistro humble` on `Mon, 26 Jan 2026 13:30:43 -0000`
...
## depthai (jazzy) - 2.31.0-1

The packages in the `depthai` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release depthai --rosdistro jazzy` on `Fri, 05 Dec 2025 18:45:30 -0000`
...
## depthai (humble) - 2.31.0-1

The packages in the `depthai` repository were released into the `humble` distro by running `/usr/bin/bloom-release depthai --rosdistro humble` on `Fri, 05 Dec 2025 18:36:03 -0000`
...
## depthai (kilted) - 3.2.1-1

The packages in the `depthai` repository were released into the `kilted` distro by running `/usr/bin/bloom-release depthai --rosdistro kilted` on `Mon, 01 Dec 2025 16:45:26 -0000`
...
## depthai (kilted) - 3.1.0-1

The packages in the `depthai` repository were released into the `kilted` distro by running `/usr/bin/bloom-release depthai --rosdistro kilted` on `Fri, 07 Nov 2025 18:19:34 -0000`
...
## depthai (kilted) - 3.0.7-1

The packages in the `depthai` repository were released into the `kilted` distro by running `/usr/bin/bloom-release depthai --rosdistro kilted` on `Tue, 07 Oct 2025 12:51:04 -0000`
...
## depthai (kilted) - 3.0.6-1

The packages in the `depthai` repository were released into the `kilted` distro by running `/usr/bin/bloom-release depthai --rosdistro kilted` on `Wed, 01 Oct 2025 07:23:58 -0000`
...
## depthai (kilted) - 3.0.5-1

The packages in the `depthai` repository were released into the `kilted` distro by running `/usr/bin/bloom-release depthai --rosdistro kilted` on `Tue, 09 Sep 2025 09:24:32 -0000`
